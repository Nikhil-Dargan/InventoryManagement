...
<div id="signup">
        ...
        <form action="signup" method="post"  name="registration" onsubmit="return validate()">
        ...
        <% } %>
           ...
           <div class="inp"><pre><br>  <input type="reset" value="Reset">     <input type="submit" value="Register" ></pre></div>
