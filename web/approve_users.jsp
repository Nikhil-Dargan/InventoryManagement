...
text-align: justify;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <font face="comic sans ms" color="green" size="29">Users To Be Approved</font><br><br>
        ...
        <%
           ...
           try{  Class.forName("com.mysql.jdbc.Driver");
               con= java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/invenmanage?zeroDateTimeBehavior=convertToNull","root","12345");
                ...
                ps=con.prepareStatement("select user_id,name,gender,dob,email,secret_ques,answer from user where role=0 and status='"+status+"'");
                rs=ps.executeQuery();
                int flag=0;
                String username="";
                String name="";
            ...
            <table id="inventry" style="border-style: double; border-color:rgb(100, 20, 100); margin:3px; border-width:5px;" cellspacing=10px width="861" >
                ...
                <tr>
                    <th style="padding:20px"><a style="font-size:20px">Approve</a></th>
        ...
        <div align="center">
        <% if(count > 1) { %>
            <input type="submit" value="Approve selected users" name="approve_selected"></form>
            <% } if(count > 1) { %>
        <form action="approve_all" method="post">
            <input type="submit" value="Approve all users" name="approve_all"></form>       
        <% } if(count == 1) { %>
        <form action="approve_all" method="post">
            <input type="submit" value="Approve User" name="approve_all"></form>       
        <% } 
        if(count==0)
        { %>
        <a>Currently you have no users to approve.</a>
       <% }
        %>
        <br><br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <%
            String status1="Approved";
               ...
               con= java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/invenmanage?zeroDateTimeBehavior=convertToNull","root","12345");
                /*Retreive for checking username already doesnt exit*/
                ps=con.prepareStatement("select user_id,name,gender,dob,email,secret_ques,answer from user where role=0 and status='"+status1+"'");
                rs=ps.executeQuery();
                flag=0;
                username="";
                name="";
       ...
       <% if(count==0)
       { %>
        <a>No approved users present.</a>
       <% } %>
       
        <br><br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <font face="comic sans ms" color="green" size="29">List Of Admins</font><br><br>
        <form action="approve_selected" method="get">
        <%
               con= java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/invenmanage?zeroDateTimeBehavior=convertToNull","root","12345");
                /*Retreive for checking username already doesnt exit*/
                ps=con.prepareStatement("select user_id,name,gender,dob,email,secret_ques,answer from user where role=1");
                rs=ps.executeQuery();
                flag=0;
                username="";
                name="";
