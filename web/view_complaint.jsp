...
text-align: justify;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <font face="comic sans ms" color="green" size="29">New Complaint</font><br><br>
        <form action="complaint_read" method="post">
        <%
           ...
           try{ 
               ...
               con= java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/invenmanage?zeroDateTimeBehavior=convertToNull","root","12345");
                ps=con.prepareStatement("select * from complaint where viewed='"+s1+"'");
                rs=ps.executeQuery();
                int flag=0;
                String username="";
                String name="";
        ...
        <tr>
           ...
           <td><input type="checkbox" name="read" value="<%=rs.getString(1)%>"/></td>
        ...
        <div align="center">
        <% if(count > 1) { %>
            <input type="submit" value="Mark selectected as pending" name="mark read"></form>
           <% } %>
       <% if(count==0)
        { %>
        <a>Currently you have no new complaints.</a>
       <% }
        %>
        <br><br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <font face="comic sans ms" color="green" size="29">Pending Complaint</font><br><br>
        <form action="complaint_resolve" method="post">
        <%
            String ss1="Pending";
               Class.forName("com.mysql.jdbc.Driver");
                
               con= java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/invenmanage?zeroDateTimeBehavior=convertToNull","root","12345");
                ps=con.prepareStatement("select * from complaint where resolved='"+ss1+"'");
                rs=ps.executeQuery();
        ...
        <tr>
           ...
           <td><input type="checkbox" name="resolve" value="<%=rs.getString(1)%>"/></td>
           <td><a><%=rs.getString(2)%></a></td>
           <td><a><%=rs.getString(3)%></a></td>
           <td><a><%=rs.getString(4)%></a></td>
           <td><a><%=rs.getString(5)%></a></td>
        ...
        <div align="center">
        <% if(count > 0) { %>
            <input type="submit" value="Mark selected as resolved" name="mark read"></form>
           <% } %>
       <% if(count==0)
        { %>
        <a>No pending complaints.</a>
       <% }
        %>
        <br><br><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <font face="comic sans ms" color="green" size="29">Resolved Complaints</font><br><br>
        ...
        <%
           ...
           Class.forName("com.mysql.jdbc.Driver");
               ...
               con= java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/invenmanage?zeroDateTimeBehavior=convertToNull","root","12345");
                ...
                ps=con.prepareStatement("select * from complaint where resolved='"+sss1+"'");
                rs=ps.executeQuery();
                flag=0;
                username="";
                name="";
