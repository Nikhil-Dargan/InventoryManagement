...
public class complaint_resolve extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       //out.println("aaa");
         String[] ids=request.getParameterValues("resolve");
           try
       {
           Class.forName("com.mysql.jdbc.Driver");
                ...
                while(i < ids.length)
                {
                    ...
                    Statement st=con.createStatement();
                     x=st.executeUpdate("update complaint set resolved='Yes' where complaint_id='"+feedbackid+"'");
                    i++;
                }
                    }
       catch(Exception e)
